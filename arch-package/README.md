To simplify installation and usage of the scripts I like most, which were been published in the [psuinfo](https://github.com/nwg-piotr/psuinfo) package, I thought to give them a PKGBUILD file, and a common command, too:
